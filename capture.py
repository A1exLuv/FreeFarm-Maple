...
WINDOWED_OFFSET_TOP = 30
# WINDOWED_OFFSET_LEFT = 10

# The top-left and bottom-right corners of the minimap
MM_TL_TEMPLATE = cv2.imread('assets/images/minimap_tl_template.png', 0)
MM_BR_TEMPLATE = cv2.imread('assets/images/minimap_br_template.png', 0)

MMT_HEIGHT = max(MM_TL_TEMPLATE.shape[0], MM_BR_TEMPLATE.shape[0])
MMT_WIDTH = max(MM_TL_TEMPLATE.shape[1], MM_BR_TEMPLATE.shape[1])

# The player's symbol on the minimap
PLAYER_TEMPLATE = cv2.imread('assets/images/player_template.png', 0)
...
class Capture:
    ...
    def _main(self):
        ...
        while True:
            ...
            # handle = user32.FindWindowW(None, 'Moonlight')
            rect = wintypes.RECT()
            ...
            # return mm_tl[0], mm_tl[1], mm_br[0], mm_br[1]
            return mm_tl[0], mm_tl[1]-WINDOWED_OFFSET_TOP, mm_br[0], mm_br[1]-WINDOWED_OFFSET_TOP
